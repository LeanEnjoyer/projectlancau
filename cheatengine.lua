...
local newLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/VanciSonic/Lgtihb/main/Lgantihub"))()
...
function Update:Window(title, icon,...)
	...
	function LIBRARY:AddChangelogs(list)
		local self = setmetatable({}, LIBRARY)
		return LIBRARY:AddChangelogs(list)
	end
...
H:AddLabel("🌐 isnahamzah.tech")
H:AddLabel("🎲 discord.gg/isnahamzah")
...
H:AddLabel("WORKING ALL EXECUTOR! ✅ ")
...
H:AddLabel(" ‼️ IF U TROLL SUGGESTION WILL BLOCK\n UR ID PLAYER SO U CANT USE THE\n SCRIPT AGAIN ‼️ ")

H:AddLabel(" [===========================] ") 

H:AddLabel(" ‼️ KALAU KAMU NGETROLL DENGAN\n MEBGIRIM KATA KATA TIDAK BERGUNA\n ID KAMU BAKALAN KAMI BLOKIR‼️ ")
...
wait(0.1)
local allowedBosses = {
    "rip_indra", "Ice Admiral", "Saber Expert", "The Saw", "Greybeard", "Mob Leader", "The Gorilla King", "Bobby", "Yeti", "Vice Admiral", 
    "Warden", "Chief Warden", "Swan", "Magma Admiral", "Fishman Lord", "Wysper", "Thunder God", "Cyborg", "Don Swan", "Diamond", 
    "Jeremy", "Fajita", "Smoke Admiral", "Awakened Ice Admiral", "Tide Keeper", "Order", "Darkbeard", "Stone", "Island Empress", 
    "Kilo Admiral", "Captain Elephant", "Beautiful Pirate", "Cake Queen", "rip_indra True Form", "Longma", "Soul Reaper", "Cake Prince", 
    "Dough King"
}

for _, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    if table.find(allowedBosses, v.Name) then
        BossName:Add(v.Name)
    end
end
end)
...
SE:AddSeperator(" Frozen Island Check ") 
FrozenIsland = SE:AddLabel("")

SE:AddToggle('Teleport Frozen Dimension [ NEED SPAWN ]', false, function(value)
...
SE:AddToggle("Auto Kill Terrorshark",_G.Makori_gay,function(value)
...
SE:AddToggle("Auto Kill Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    SE:AddToggle("Auto Kill Piranha",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        SE:AddToggle('Auto Kill GhostShip', _G.bjirFishBoat, function(value)
...
SE:AddSeperator(" Item Drop ") 

SE:AddToggle('Auto Get Anchor [ Need Material ]', _G.BjirAnchorCuy, function(state)
...
task.spawn(function()
    ...
    SerS:AddSeperator("Moon Check")

local moon_finder = SerS:AddLabel("Moon Phase : 0% ")
    ...
    while task.wait() do
        pcall(function()
            ...
            if moonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
                moon_finder:Set("Moon Phase : (🌑) : Full Moon !!")
            elseif moonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
                moon_finder:Set("Moon Phase : (🌒) : 75%")
            elseif moonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
                moon_finder:Set("Moon Phase : (🌓) : 50%")
            elseif moonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
                moon_finder:Set("Moon Phase : (🌗) : 25%")
            elseif moonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
                moon_finder:Set("Moon Phase : (🌖) : 15%")
            end
        end)
    end
end)
...
SerS:AddSeperator("Haki Check")

local haki_finder = SerS:AddLabel("Haki : Not Spawn")
local haki_rank = SerS:AddLabel("Rank : Not Spawn")
local haki_type = SerS:AddLabel("Type : Not Spawn")
local haki_price = SerS:AddLabel("Price : Not Spawn") 

spawn(function()
    while task.wait() do
        pcall(function()
        local checkColor = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ColorsDealer","1")
          if checkColor == "Orange Soda" then
            haki_finder:Set("Haki : Orange Soda")
            haki_rank:Set("Rank : #01")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Bright Yellow" then
            haki_finder:Set("Haki : Bright Yellow")
            haki_rank:Set("Rank : #02")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Yellow Sunshine" then
            haki_finder:Set("Haki : Yellow Sunshine")
            haki_rank:Set("Rank : #03")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Slimy Green" then
            haki_finder:Set("Haki : Slimy Green")
            haki_rank:Set("Rank : #04")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Green Lizard" then
            haki_finder:Set("Haki : Green Lizard")
            haki_rank:Set("Rank : #05")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Blue Jeans" then
            haki_finder:Set("Haki : Blue Jeans")
            haki_rank:Set("Rank : #06")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Plump Purple" then
            haki_finder:Set("Haki : Plump Purple")
            haki_rank:Set("Rank : #07")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Fiery Rose" then
            haki_finder:Set("Haki : Fiery Rose")
            haki_rank:Set("Rank : #08")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Heat Wave" then
            haki_finder:Set("Haki : Heat Wave")
            haki_rank:Set("Rank : #09")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Absolute Zero" then
            haki_finder:Set("Haki : Absolute Zero")
            haki_rank:Set("Rank : #10")
            haki_type:Set("Type : Normal") 
            haki_price:Set("Price : 1,500 [ FRAGMENT ] ") 
          elseif checkColor == "Snow White" then
            haki_finder:Set("Haki : Snow White")
            haki_rank:Set("Rank : #11")
            haki_type:Set("Type : Legendary") 
            haki_price:Set("Price : 7,500 [ FRAGMENT ] ") 
          elseif checkColor == "Pure Red" then
            haki_finder:Set("Haki : Pure Red")
            haki_rank:Set("Rank : #12")
            haki_type:Set("Type : Legendary") 
            haki_price:Set("Price : 7,500 [ FRAGMENT ] ") 
          elseif checkColor == "Winter Sky" then
            haki_finder:Set("Haki : Winter Sky")
            haki_rank:Set("Rank : #13")
            haki_type:Set("Type : Legendary") 
            haki_price:Set("Price : 7,500 [ FRAGMENT ] ") 
          end
        end)
...
SerS:AddButton("Buy Haki Color",function(state)
    spawn(function()
        while wait() do
            if state then
                local args = {
...
SerS:AddSeperator("Sword Legend Check")

local sword_finder = SerS:AddLabel("Sword : Not Spawn")
local sword_price = SerS:AddLabel("Price : Not Spawn") 

spawn(function()
    while task.wait() do
        pcall(function()
        local checkSword = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","1")
            if checkSword == "Shisui" then
                sword_finder:Set("Sword : Shisui")
                sword_price:Set("Price : 2,000,000 [ BELI ] ")
            elseif checkSword == "Saddi" then
                sword_finder:Set("Sword : Saddi")
                sword_price:Set("Price : 2,000,000 [ BELI ] ")
            elseif checkSword == "Wando" then
                sword_finder:Set("Sword : Wando")
                sword_price:Set("Price : 2,000,000 [ BELI ] ")
            end
        end)
    end
...
SerS:AddButton("Buy Legendary Sword",function(state)
    spawn(function()
        while wait() do
            if state then
                pcall(function()
...
RaceV4:AddLabel("IND: Harus ke third sea bre 😁")
